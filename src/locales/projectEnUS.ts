export default [
  ...
  },
  {
    ...
    "type": "1",
    "time": "2018/06～",
    "content": "A responsive website of travel topic. It includes 2 parts content display and profile center.",
    ...
    "learned": "use rollup to trans ES6 to ES5, use AWS codepipeline & docker for auto deploy, why used stg environment"
  ...
  },
  {
    ...
    "name": "A webApp in Alipay platform",
    "country": "1",
    "type": "1",
    ...
    "learned": "Used immutable.js for letting reducer be maintainable and testable"
  },
  {
    "id": 22,
    "cover": {
  ...
  },
  {
    ...
    "name": "A recruitment products home site",
    "country": "1",
    "type": "1",
    "time": "2017/08",
    "content": "",
  ...
  },
  {
    ...
    "learned": "In cart, the total price will change with count add or minus.This shows different components share same state.\rIn order confirm page, by using angular's router configa auth check is provided for calling login."
  },
  {
    "id": 10,
    "cover": {
  ...
  },
  {
    ...
    "content": "It's a web APP which is based on Dclound's products, IOS and Android both works excellent.",
    "link": "",
    "codeLink": "",
    "skill": [
      "MUI",
