const projectJaJP = [
  ...
  },
  {
    ...
    learned:
      'rollupでjsにまとめる経験、継続的なデプロイ(AWS codepipeline & docker)経験、stg環境のさよう'
  },
  {
    id: 25,
    cover: {
  ...
  },
  {
    ...
    learned:
      'immutable.JSを使って、Reducerの肥大化を防ぎ、保守性・改修性を上げることを目的とします。'
  },
  {
    id: 20,
    cover: {
